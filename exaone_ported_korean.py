...
torch.save(total_logits, str(transformers.__version__)+f'_exaone_ported_logit_{DEVICE}_kr.pt')
torch.save(total_tokens, str(transformers.__version__)+f'_exaone_ported_token_{DEVICE}_kr.pt')
